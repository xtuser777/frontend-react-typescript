...
export function FreightOrders(): JSX.Element {
  ...
  const remove = async (id: number) => {
    ...
    if (response) {
      const order = orders.find((item) => item.id == id) as FreightOrder;
  ...
  return (
    <>
      <CardTitle text="Controlar Pedidos de Frete" />
